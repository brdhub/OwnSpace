export const appReleases = [
  {
    ...
    updatedAtIso: "2026-09-24",
    notes: [
      "优化首页：投递统计集中展示，并可按招聘类型切换查看进展。",
      "优化投递记录 UI：折叠筛选、快速遍历投递网址，调整新增与导出入口。",
      "增加投递轨迹：自动记录状态变化，并支持按日期补录历史状态。",
      "完善 AI 面试：结合投递 JD 与选定简历进行五题文字模拟、追问和复盘。",
      "秋招企业移至简历模块，旧入口会保留筛选条件跳转。",
    ],
  },
  {
    version: "3.6",
    updatedAt: "2026年9月23日",
    updatedAtIso: "2026-09-23",
    notes: [
      "投递记录新增城市、岗位类型和所用简历，支持筛选、同公司记录折叠及补全缺失类型。",
      "投递导出新增数量趋势、进度和招聘类型统计图，并支持下载统计图片。",
      "整理投递页面操作入口与过时文档。",
    ],
  },
  {
